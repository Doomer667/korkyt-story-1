...
const createModal = (id, image, header, body, className, triggerElement) => {
  ...
  closeButton.onclick = () => closeDialog(id, triggerElement)
...
const closeDialog = (id, triggerElement) => {
  const modal = document.getElementById(id)
  modal.remove()
  console.log(triggerElement)
  triggerElement.setAttribute('class', 'circle')
}
...
slideTwoTrigger.onclick = () => {
  ...
  openModal(slideTwo, id, link, header, body, slideTwoTrigger)
...
slideSixTrigger.onclick = () => {
  ...
  openModal(slideSix, id, link, header, body, slideSixTrigger)
...
slideElevenTrigger.onclick = () => {
  ...
  openModal(slideEleven, id, link, header, body, slideElevenTrigger)
  slideElevenTrigger.setAttribute('class', 'circle disabled')
}

const openModal = (element, id, link, header, body, triggerElement) => {
  element.appendChild(createModal(id, link, header, body, 'modal-dialog', triggerElement))
}
...
imageOneTrigger.onclick = () => {
  ...
  openModal(slideFive, id, link, header, body, imageOneTrigger)
  imageOneTrigger.setAttribute('class', 'circle disabled')
}
...
imageTwoTrigger.onclick = () => {
  ...
  openModal(slideFive, id, link, header, body, imageTwoTrigger)
  imageTwoTrigger.setAttribute('class', 'circle disabled')
}
...
imageThreeTrigger.onclick = () => {
  ...
  openModal(slideFive, id, link, header, body, imageThreeTrigger)
  imageThreeTrigger.setAttribute('class', 'circle disabled')
}
